...
const titlesWithDuration = recipes.map(recipe => `${recipe.title} (${recipe.duration}min)`); // ['Crepes (60min)', ...]
console.log(titlesWithDuration);

const timePerServing = recipes.map(recipe => recipe.duration / recipe.servings); // [20, 10, 432, 12]
